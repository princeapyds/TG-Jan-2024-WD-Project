...
app = Flask("False Alarm Cases.xlsx")

@app.route("/train")
def train():
    df = pd.read_excel("C:\\Users\\VIRAJ GORE\\Documents\\False Alarm Cases.xlsx")
...
def predict():
    ...
    data["Humidity"] , data["H2S Content"], data["detected by"]]).reshape(1,6)
